...
?>
                    ...
                    <form class="row gy-4" action="./adddoc_db.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <label class="label_field text-white hidden">.</label>
                            </div>
                            <div class="col-md-6">
                            ...
                            <!--<multi-input>
                                <input list="member" class=" form-control" id="membername" name="membername" placeholder="Select-Member">
                                <datalist id="member" name="membername">
                                ...
                                <a type="button" class="btn btn-primary btn-sm text-white" id="get">Get</a>
                                <p id="values"></p>
                                <input type="text" id="values">-->
                                <label for="membername" class="form-label ">ส่งถึง</label>
                                <select class="form-select form-control" id="membername" name="membername">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-select form-control" id="appname1" name="appname1">
                                    <option disabled="" class="form-control " selected=""> เลือกผู้อนุมัติ (S3 - S4)</option>
                                    <?php
                                    $query = "SELECT * FROM `tblistappname` WHERE listlevel = 's3' OR listlevel = 's4';";
                            ...
                            <label class="label_field text-white hidden">.</label>
                                <select class="form-select form-control" id="appname2" name="appname2">
                                    <option disabled="" class="form-control " selected=""> เลือกผู้อนุมัติ (S4 - S8)</option>
                                    <option value="ไม่มีผู้อนุมัติ">ไม่มีผู้อนุมัติ</option>
                                    <?php
                                    $query = "SELECT * FROM `tblistappname` WHERE listlevel = 's4' OR listlevel = 's5' OR listlevel = 's6' OR listlevel = 's7' OR listlevel = 's8';";
                                    // $query = mysqli_query($con, $qr);
                                    $result = mysqli_query($conn,$query);
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
