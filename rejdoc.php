                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active" >
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="rejdoc.php">Disapproved Document</a></li>
        ...
        <?php include ('./header.php') ;?>
         ...
         <div class="page-title-area">
            ...
            <div class="main-content-inner">          
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        <h4 class="header-title">Disapproved Document</h4>
                    <div class="container1">
                    <div class="table-responsive col-lg-12">
                        <?php 
                            $aa = $_SESSION['membername'];
                            $sql = "SELECT * FROM `tbdoc` WHERE docstatus = '2' ";
                      ...
                      <thead class="thead-light">
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                          ...
                          <td>
                           <a class="btn btn-primary" href="viewrej.php?doc_id=<?php echo $row['docid'] ?>">View</a>
                          </td>
                          </tr>
                          <?php endwhile; ?>
                        </tbody>
